...
FILLER_AUDIO_DEFAULT_SILENCE_THRESHOLD_SECONDS = 3
...
class CutOffResponse(BaseModel):
    messages: List[BaseMessage] = [BaseMessage(text="Sorry?"),BaseMessage(text="I cant hear you "),BaseMessage(text="What does that means")]
...
class ChatGPTAgentConfig(AgentConfig, type=AgentType.CHAT_GPT.value):
    ...
    temperature: float = LLM_AGENT_DEFAULT_TEMPERATURE
    max_tokens: int = LLM_AGENT_DEFAULT_MAX_TOKENS
    # cut_off_response: Optional[CutOffResponse] =  CutOffResponse(
    #         messages=[
    #             BaseMessage(text="Sorry?"),
    #             BaseMessage(text="I can't hear you"),
    #             BaseMessage(text="What does that mean?")
    #         ]
    #     ),
    cut_off_response: Optional[CutOffResponse] =None
