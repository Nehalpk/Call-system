...
class OutboundCall:
    def __init__(
        ...
        status_callback1:str= None,
        status_callback_event1:list =None,
        digits: Optional[
            str
        ...
        self.status_callback1 =status_callback1 ,    
        self.status_callback_event1 =status_callback_event1,
    ...
    async def start(self):
        ...
        self.telephony_id = await self.telephony_client.create_call(
            ...
            to_phone=self.to_phone,
            from_phone=self.from_phone,
            status_callback1 =self.status_callback1 ,
            status_callback_event1 =self.status_callback_event1,
