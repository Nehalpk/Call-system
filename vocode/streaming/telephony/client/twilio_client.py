...
class TwilioClient(BaseTelephonyClient):
    ...
    async def create_call(
        ...
        status_callback_event1 :list = ['completed', 'busy', 'failed', 'no-answer', 'canceled','queued', 'initiated', 'ringing', 'answered', 'in-progress']
    ) -> str:
        # TODO: Make this async. This is blocking.
        ...
        twilio_call = self.twilio_client.calls.create(
            ...
            status_callback_event=status_callback_event1,
            **self.get_telephony_config().extra_params,
        )
